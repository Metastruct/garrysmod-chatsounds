...
L["molotov round mvp anthem"]={{path="music/kitheory_01/roundmvpanthem_01.mp3",length=4.0918126106262}}
L["molotov round ten second countdown"]={{path="music/kitheory_01/roundtenseccount.mp3",length=7.2478332519531}}
L["molotov start action"]={{path="music/kitheory_01/startaction_01.mp3",length=9.116527557373}}
L["molotov start round"]={{path="music/kitheory_01/startround_01.mp3",length=12.379361152649}}
L["molotov won round"]={{path="music/kitheory_01/wonround.mp3",length=3.7650001049042}}
c.EndList()