...
L["a predictable failure doctor freeman"]={{path="vo/citadel/br_mock04.wav",length=3.5630612244898}}
...
L["and this one has proven to be a fine pawn for those who control him"]={{path="vo/citadel/br_newleader_c.wav",length=5.2749886621315}}
...
L["gordon freeman"]={{path="vo/k_lab/br_thereheis.wav",length=1.5055102040816}}
L["guards get in here"]={{path="vo/citadel/br_guards.wav",length=2.3006349206349}}
L["ha ha ha ha eheh huh"]={{path="vo/citadel/br_laugh01.wav",length=3.8755328798186}}
...
L["i could have told you that was pointless doctor freeman"]={{path="vo/citadel/br_mock07.wav",length=3.9589569160998}}
...
L["if id known you were going come straight up to my office i wouldnt have bothered hunting you in the first place"]={{path="vo/citadel/br_guest_f.wav",length=6.5963945578231}}
...
L["it must be fought tooth and nail beginning with the basest of human urges the urge to reproduce"]={{path="vo/breencast/br_instinct19.wav",length=8.3834240362812}}
...
L["no"]={{path="vo/citadel/br_no.wav",length=0.78303854875283}}
...
L["whats this put it over there"]={{path="vo/citadel/br_gravgun.wav",length=1.9662585034014}}
