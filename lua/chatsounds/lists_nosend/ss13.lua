...
L["clownstep"]={{path="chatsounds/autoadd/ss13/clownstep/clownstep1.ogg",length=0.252},{path="chatsounds/autoadd/ss13/clownstep/clownstep2.ogg",length=0.273}}
...
L["yeah there we go apc destroyed mission accomplished"]={{path="chatsounds/autoadd/ss13/yeah there we go apc destroyed mission accomplished.ogg",length=2.949}}
L["you wanna put a bangin donk on it"]={{path="chatsounds/autoadd/ss13/you wanna put a bangin donk on it.ogg",length=1.556}}
L["your move creep"]={{path="chatsounds/autoadd/ss13/your move creep.ogg",length=1.555}}
c.EndList()