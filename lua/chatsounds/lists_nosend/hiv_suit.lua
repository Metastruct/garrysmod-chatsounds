...
L["666 sees"]={{path="chatsounds/autoadd/hiv_suit/666 sees.ogg",length=2.807}}
L["acquired cumptoms"]={{path="chatsounds/autoadd/hiv_suit/acquired cumptoms.ogg",length=1.609}}
L["atmospheric cicehpsomta"]={{path="chatsounds/autoadd/hiv_suit/atmospheric cicehpsomta.ogg",length=1.960}}
L["automat lal"]={{path="chatsounds/autoadd/hiv_suit/automat lal.ogg",length=1.213}}
...
L["schneer quwuwu"]={{path="chatsounds/autoadd/hiv_suit/schneer quwuwu.ogg",length=1.442}}
L["warning cum overload"]={{path="chatsounds/autoadd/hiv_suit/warning cum overload.ogg",length=3.387}}
L["warning possible gay detected"]={{path="chatsounds/autoadd/hiv_suit/warning possible gay detected.ogg",length=3.425}}
c.EndList()