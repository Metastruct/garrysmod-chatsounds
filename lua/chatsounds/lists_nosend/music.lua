...
L["a la menthe"]={{path="chatsounds/autoadd/music/a la menthe.ogg",length=9.699}}
...
L["hello world"]={{path="chatsounds/autoadd/music/hello world.ogg",length=2.209}}
...
L["putin walking loop"]={{path="chatsounds/autoadd/music/putin walking loop.ogg",length=9.595}}
