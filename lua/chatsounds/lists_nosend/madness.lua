...
L["angels"]={{path="chatsounds/autoadd/madness/angels.ogg",length=7.9876643990929708}}
L["bbb"]={{path="chatsounds/autoadd/madness/bbb.ogg",length=1.2190249433106577}}
L["bringo"]={{path="chatsounds/autoadd/madness/bringo.ogg",length=0.65965986394557818}}
L["checkitout"]={{path="chatsounds/autoadd/madness/checkitout.ogg",length=1.2722902494331065}}
L["dave need a paddle"]={{path="chatsounds/autoadd/madness/dave need a paddle.ogg",length=1.5031292517006802}}
L["magic"]={{path="chatsounds/autoadd/madness/magic.ogg",length=5.3403628117913833}}
L["magic2"]={{path="chatsounds/autoadd/madness/magic2.ogg",length=7.5810884353741494}}
L["ramiel"]={{path="chatsounds/autoadd/madness/ramiel.ogg",length=2.7454648526077099}}
