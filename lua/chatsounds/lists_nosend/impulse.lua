...
L["healing spring"]={{path="chatsounds/autoadd/impulse/healing spring.ogg",length=20.062086167800455}}
...
L["is that wrong slash does that make me a bad person"]={{path="chatsounds/autoadd/impulse/is that wrong slash does that make me a bad person.ogg",length=6.5055328798185945}}
