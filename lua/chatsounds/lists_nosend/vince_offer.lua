...
L["5 seconds 4 5 seconds its done"]={{path="chatsounds/autoadd/vince_offer/5 seconds 4 5 seconds its done.ogg",length=3.762}}
L["and watch this tacos fetuccini linguine martini bikini"]={{path="chatsounds/autoadd/vince_offer/and watch this tacos fetuccini linguine martini bikini.ogg",length=5.904}}
L["hi its vince with shamwow"]={{path="chatsounds/autoadd/vince_offer/hi its vince with shamwow.ogg",length=2.508}}
L["hi its vince with slapchop"]={{path="chatsounds/autoadd/vince_offer/hi its vince with slapchop.ogg",length=2.586}}
L["lifes hard enough as it is you dont want to cry anymore"]={{path="chatsounds/autoadd/vince_offer/lifes hard enough as it is you dont want to cry anymore.ogg",length=2.926}}
