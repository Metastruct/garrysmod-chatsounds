...
L["bayonettagameover"]={{path="chatsounds/autoadd/beauty_bomber/bayonettagameover.ogg",length=8.790}}
L["bayonettascarboroughfairequipped"]={{path="chatsounds/autoadd/beauty_bomber/bayonettascarboroughfairequipped.ogg",length=25.103}}
...
L["who put you on the planet"]={{path="chatsounds/autoadd/beauty_bomber/who put you on the planet/1.ogg",length=2.472},{path="chatsounds/autoadd/beauty_bomber/who put you on the planet/2.ogg",length=2.809}}
...
L["wotwtripod"]={{path="chatsounds/autoadd/beauty_bomber/wotwtripod.ogg",length=9.066}}
L["wow"]={{path="chatsounds/autoadd/beauty_bomber/wow.ogg",length=0.560}}
L["wow its a two million year old ice cube"]={{path="chatsounds/autoadd/beauty_bomber/wow its a two million year old ice cube.ogg",length=2.600}}
L["wowowowowowowowow"]={{path="chatsounds/autoadd/beauty_bomber/wowowowowowowowow.ogg",length=10.933}}
L["yeeaaahhhh"]={{path="chatsounds/autoadd/beauty_bomber/yeeaaahhhh.ogg",length=0.871}}
L["you are like a baby"]={{path="chatsounds/autoadd/beauty_bomber/you are like a baby.ogg",length=1.493}}
L["youre an inanimate fucking object"]={{path="chatsounds/autoadd/beauty_bomber/youre an inanimate fucking object.ogg",length=2.122}}
c.EndList()