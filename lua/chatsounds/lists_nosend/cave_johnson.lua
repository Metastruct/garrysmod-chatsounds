c.StartList("cave_johnson")
L["alright ive been thinking"]={{path="chatsounds/autoadd/cave_johnson/alright ive been thinking.ogg",length=1.231}}
L["burns your house down"]={{path="chatsounds/autoadd/cave_johnson/burns your house down.ogg",length=1.390}}
L["combustable"]={{path="chatsounds/autoadd/cave_johnson/combustable.ogg",length=0.897}}
L["combustable lemon"]={{path="chatsounds/autoadd/cave_johnson/combustable lemon.ogg",length=1.299}}
L["cough"]={{path="chatsounds/autoadd/cave_johnson/cough.ogg",length=2.173}}
L["do you know"]={{path="chatsounds/autoadd/cave_johnson/do you know.ogg",length=0.765}}
...
L["with the lemons"]={{path="chatsounds/autoadd/cave_johnson/with the lemons.ogg",length=1.130}}
c.EndList()