...
L["oooooooo"]={{path="chatsounds/autoadd/snipaaz/oooooooo.ogg",length=7.2024943310657594}}
L["out out"]={{path="chatsounds/autoadd/snipaaz/out out.ogg",length=1.3537414965986394}}
L["screwup"]={{path="chatsounds/autoadd/snipaaz/screwup.ogg",length=12.740408163265306}}
L["somebodys in here using the phone"]={{path="chatsounds/autoadd/snipaaz/somebodys in here using the phone.ogg",length=2.181768707482993}}
L["this is my favorite story"]={{path="chatsounds/autoadd/snipaaz/this is my favorite story.ogg",length=2.6470748299319729}}
L["this is the same mistake that steve jobs made"]={{path="chatsounds/autoadd/snipaaz/this is the same mistake that steve jobs made.ogg",length=4.6001360544217684}}
L["thxcrank"]={{path="chatsounds/autoadd/snipaaz/thxcrank.ogg",length=20.108480725623583}}
L["vhs"]={{path="chatsounds/autoadd/snipaaz/vhs.ogg",length=27.782290249433107}}
L["yamaha"]={{path="chatsounds/autoadd/snipaaz/yamaha.ogg",length=1.7966439909297052}}
c.EndList()