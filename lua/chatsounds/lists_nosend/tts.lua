c.StartList("tts")
L["barbecue"]={{path="chatsounds/autoadd/tts/barbecue.ogg",length=0.80979591836734699}}
L["the hook died"]={{path="chatsounds/autoadd/tts/the hook died.ogg",length=0.94222222222222218}}
