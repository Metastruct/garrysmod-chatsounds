...
L["eugh hey"]={{path="chatsounds/autoadd/eggman/eugh hey.ogg",length=1.409}}
...
L["itll take more then that"]={{path="chatsounds/autoadd/eggman/itll take more then that.ogg",length=1.382}}
L["ive had enough of this furry romance bullshit"]={{path="chatsounds/autoadd/eggman/ive had enough of this furry romance bullshit.ogg",length=3.370}}
L["lights out"]={{path="chatsounds/autoadd/eggman/lights out.ogg",length=1.280}}
L["notbad"]={{path="chatsounds/autoadd/eggman/notbad.ogg",length=1.174}}
L["now we will"]={{path="chatsounds/autoadd/eggman/now we will.ogg",length=0.903}}
L["oh you little sneaky theif ill smash you to pieces"]={{path="chatsounds/autoadd/eggman/oh you little sneaky theif ill smash you to pieces.ogg",length=4.950}}
L["parallel attack"]={{path="chatsounds/autoadd/eggman/parallel attack.ogg",length=1.107}}
L["prepare to be skewered"]={{path="chatsounds/autoadd/eggman/prepare to be skewered.ogg",length=1.816}}
...
L["what are you doing im right here"]={{path="chatsounds/autoadd/eggman/what are you doing im right here.ogg",length=2.219}}
L["will end it"]={{path="chatsounds/autoadd/eggman/will end it.ogg",length=1.242}}
L["wwhat nno this cant be"]={{path="chatsounds/autoadd/eggman/wwhat nno this cant be.ogg",length=4.526}}
L["you know what they say the more the merrier"]={{path="chatsounds/autoadd/eggman/you know what they say the more the merrier.ogg",length=3.286}}
c.EndList()