c.StartList("lotw")
L["aber wenn wir ganz doll dran glauben"]={{path="chatsounds/autoadd/lotw/aber wenn wir ganz doll dran glauben.ogg",length=2.279}}
...
L["fick dich und deine mudda du hurensohn"]={{path="chatsounds/autoadd/lotw/fick dich und deine mudda du hurensohn.ogg",length=2.678}}
L["ganz ehrlich legolas du bist echt die schwulste sau von allen"]={{path="chatsounds/autoadd/lotw/ganz ehrlich legolas du bist echt die schwulste sau von allen.ogg",length=2.433}}
L["guck mal stock gegen wand"]={{path="chatsounds/autoadd/lotw/guck mal stock gegen wand.ogg",length=1.319}}
L["halt mal die schnauze jetz hier"]={{path="chatsounds/autoadd/lotw/halt mal die schnauze jetz hier.ogg",length=1.919}}
L["halts maul du hurensohn"]={{path="chatsounds/autoadd/lotw/halts maul du hurensohn.ogg",length=2.329}}
L["hey mach mal licht"]={{path="chatsounds/autoadd/lotw/hey mach mal licht.ogg",length=1.619}}
L["hue"]={{path="chatsounds/autoadd/lotw/hue.ogg",length=1.234}}
L["ich bin alkoholiker"]={{path="chatsounds/autoadd/lotw/ich bin alkoholiker.ogg",length=2.029}}
L["ich lass mir von euch jetz hier nich die stimmung versauen"]={{path="chatsounds/autoadd/lotw/ich lass mir von euch jetz hier nich die stimmung versauen.ogg",length=1.904}}
...
L["mit so viel liebe zum detail"]={{path="chatsounds/autoadd/lotw/mit so viel liebe zum detail.ogg",length=1.559}}
L["nur sonntags"]={{path="chatsounds/autoadd/lotw/nur sonntags.ogg",length=1.009}}
...
L["und guck mal wie das gemacht is"]={{path="chatsounds/autoadd/lotw/und guck mal wie das gemacht is.ogg",length=1.429}}
