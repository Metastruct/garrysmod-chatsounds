...
L["its over"]={{path="chatsounds/autoadd/mgrr/its over.ogg",length=0.886}}
L["just a little too late as usual"]={{path="chatsounds/autoadd/mgrr/just a little too late as usual.ogg",length=3.709}}
L["lets dance"]={{path="chatsounds/autoadd/mgrr/lets dance.ogg",length=1.330}}
L["lets go"]={{path="chatsounds/autoadd/mgrr/lets go.ogg",length=1.426}}
