...
L["marx3"]={{path="chatsounds/autoadd/vin/marx3.ogg",length=2.113}}
L["marx4"]={{path="chatsounds/autoadd/vin/marx4.ogg",length=1.707}}
L["marxscream"]={{path="chatsounds/autoadd/vin/marxscream.ogg",length=4.342}}
L["mortis longdick"]={{path="chatsounds/autoadd/vin/mortis longdick.ogg",length=2.137}}
