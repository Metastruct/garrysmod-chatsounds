...
L["marx"]={{path="chatsounds/autoadd/vin/marx/1.ogg",length=3.286},{path="chatsounds/autoadd/vin/marx/2.ogg",length=2.264},{path="chatsounds/autoadd/vin/marx/3.ogg",length=2.113},{path="chatsounds/autoadd/vin/marx/4.ogg",length=1.707}}
L["marxscream"]={{path="chatsounds/autoadd/vin/marxscream.ogg",length=4.342}}
L["no keep going"]={{path="chatsounds/autoadd/vin/no keep going.ogg",length=1.376}}
...
L["parrotscream"]={{path="chatsounds/autoadd/vin/parrotscream.ogg",length=1.432}}
L["parrotscreamdistorted"]={{path="chatsounds/autoadd/vin/parrotscreamdistorted.ogg",length=3.124}}
