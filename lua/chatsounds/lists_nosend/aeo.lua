c.StartList("aeo")
L["4 til cock"]={{path="chatsounds/autoadd/aeo/4 til cock.ogg",length=1.7070748299319727}}
L["4tilcock1"]={{path="chatsounds/autoadd/aeo/4tilcock1.ogg",length=0.55147392290249431}}
L["4tilcock2"]={{path="chatsounds/autoadd/aeo/4tilcock2.ogg",length=0.56671201814058958}}
...
L["gordon grenaaaaaaaades"]={{path="chatsounds/autoadd/aeo/gordon grenaaaaaaaades.ogg",length=4.0397052154195014}}
L["how old were you when you started sucking dick"]={{path="chatsounds/autoadd/aeo/how old were you when you started sucking dick.ogg",length=1.7889569160997731}}
L["i may be an idiot but im an idiot"]={{path="chatsounds/autoadd/aeo/i may be an idiot but im an idiot.ogg",length=4.1912018140589566}}
...
L["thatisnotheissue"]={{path="chatsounds/autoadd/aeo/thatisnotheissue.ogg",length=1.0158730158730158}}
L["the issue is your tissue"]={{path="chatsounds/autoadd/aeo/the issue is your tissue.ogg",length=1.1000453514739228}}
L["you are grounded 4 til cock"]={{path="chatsounds/autoadd/aeo/you are grounded 4 til cock.ogg",length=2.8448526077097505}}
L["you guys have fun"]={{path="chatsounds/autoadd/aeo/you guys have fun.ogg",length=0.70820861678004532}}
L["youre soos"]={{path="chatsounds/autoadd/aeo/youre soos.ogg",length=0.32653061224489793}}
c.EndList()