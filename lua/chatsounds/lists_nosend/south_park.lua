c.StartList("south_park")
L["chris hansen"]={{path="chatsounds/autoadd/south_park/chris hansen.ogg",length=1.331}}
L["i thought this was america huh isnt this america"]={{path="chatsounds/autoadd/south_park/i thought this was america huh isnt this america.ogg",length=2.997}}
L["im chriiis haaaaanseeeen"]={{path="chatsounds/autoadd/south_park/im chriiis haaaaanseeeen.ogg",length=4.059}}
L["im chris haansen"]={{path="chatsounds/autoadd/south_park/im chris haansen.ogg",length=1.925}}
L["im chris hansen"]={{path="chatsounds/autoadd/south_park/im chris hansen.ogg",length=1.471}}
