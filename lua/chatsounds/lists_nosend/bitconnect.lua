...
L["wasowasowasowassuuuup bitconneeect"]={{path="chatsounds/autoadd/bitconnect/wasowasowasowassuuuup bitconneeect.ogg",length=6.431}}
L["we are coming and we are coming in waves"]={{path="chatsounds/autoadd/bitconnect/we are coming and we are coming in waves.ogg",length=4.696}}
L["we are really changing the world as we know it"]={{path="chatsounds/autoadd/bitconnect/we are really changing the world as we know it.ogg",length=3.160}}
L["what am i gonna do"]={{path="chatsounds/autoadd/bitconnect/what am i gonna do.ogg",length=2.122}}
L["when i yun started to put ten thousand dos a dayum in hur right on her you know on her table"]={{path="chatsounds/autoadd/bitconnect/when i yun started to put ten thousand dos a dayum in hur right on her you know on her table.ogg",length=6.245}}
L["whooaa"]={{path="chatsounds/autoadd/bitconnect/whooaa.ogg",length=1.036}}
L["whooaa hahahaha"]={{path="chatsounds/autoadd/bitconnect/whooaa hahahaha.ogg",length=2.993}}
L["woow"]={{path="chatsounds/autoadd/bitconnect/woow.ogg",length=1.363}}
L["wowowowo whassup"]={{path="chatsounds/autoadd/bitconnect/wowowowo whassup.ogg",length=2.308}}
L["wwhatt"]={{path="chatsounds/autoadd/bitconnect/wwhatt.ogg",length=1.395}}
c.EndList()