c.StartList("hl2_extras")
L["get back here"]={{path="chatsounds/autoadd/hl2_extras/get back here.ogg",length=2.854}}
L["gmanlaugh"]={{path="chatsounds/autoadd/hl2_extras/gmanlaugh.ogg",length=3.155}}
L["gmansnarl"]={{path="chatsounds/autoadd/hl2_extras/gmansnarl.ogg",length=5.033}}
