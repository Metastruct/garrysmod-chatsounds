...
L["sorry i was just working out"]={{path="chatsounds/autoadd/merasmus/sorry i was just working out.ogg",length=1.782}}
L["then the poliss arrived"]={{path="chatsounds/autoadd/merasmus/then the poliss arrived.ogg",length=1.562}}
L["this cunt is binding mortal"]={{path="chatsounds/autoadd/merasmus/this cunt is binding mortal.ogg",length=3.441}}
L["tits are now on sale mortals"]={{path="chatsounds/autoadd/merasmus/tits are now on sale mortals.ogg",length=3.197}}
L["welcome mortals to my sex kingdom"]={{path="chatsounds/autoadd/merasmus/welcome mortals to my sex kingdom.ogg",length=3.783}}
L["why did you do that"]={{path="chatsounds/autoadd/merasmus/why did you do that.ogg",length=1.684}}
L["you dare to fuck merasmus"]={{path="chatsounds/autoadd/merasmus/you dare to fuck merasmus.ogg",length=2.441}}
L["youre just a big stupid pile of shit"]={{path="chatsounds/autoadd/merasmus/youre just a big stupid pile of shit.ogg",length=2.294}}
c.EndList()