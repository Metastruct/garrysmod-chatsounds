...
L["dog3"]={{path="chatsounds/autoadd/css_cool_energydrink_soundpack_css/dog3.ogg",length=8.3324263038548754}}
L["enemydown"]={{path="chatsounds/autoadd/css_cool_energydrink_soundpack_css/enemydown.ogg",length=3.6351473922902495}}
L["fireassis"]={{path="chatsounds/autoadd/css_cool_energydrink_soundpack_css/fireassis.ogg",length=6.7193197278911567}}
L["followme"]={{path="chatsounds/autoadd/css_cool_energydrink_soundpack_css/followme.ogg",length=7.0937868480725621}}
L["geomg"]={{path="chatsounds/autoadd/css_cool_energydrink_soundpack_css/geomg.ogg",length=1.1493877551020408}}
L["getoutblow"]={{path="chatsounds/autoadd/css_cool_energydrink_soundpack_css/getoutblow.ogg",length=6.5029024943310656}}
L["goodness"]={{path="chatsounds/autoadd/css_cool_energydrink_soundpack_css/goodness.ogg",length=3.2454421768707484}}
...
L["whos the man"]={{path="chatsounds/autoadd/css_cool_energydrink_soundpack_css/whos the man.ogg",length=2.8734693877551019}}
L["youfuckingbitch"]={{path="chatsounds/autoadd/css_cool_energydrink_soundpack_css/youfuckingbitch.ogg",length=14.442086167800454}}
c.EndList()