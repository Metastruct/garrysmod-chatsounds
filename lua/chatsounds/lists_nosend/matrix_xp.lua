c.StartList("matrix_xp")
L["amateurs"]={{path="chatsounds/autoadd/matrix_xp/amateurs.ogg",length=0.98750566893424041},}
L["an agent can take the form of any being within the matrix"]={{path="chatsounds/autoadd/matrix_xp/an agent can take the form of any being within the matrix.ogg",length=3.3212698412698414},}
L["but is there a difference"]={{path="chatsounds/autoadd/matrix_xp/but is there a difference.ogg",length=3.2959410430839},}
L["but it slows down over time"]={{path="chatsounds/autoadd/matrix_xp/but it slows down over time.ogg",length=1.9032879818594104},}
L["can i help you with that"]={{path="chatsounds/autoadd/matrix_xp/can i help you with that.ogg",length=1.1985487528344672},}
L["customer support this is richard jones from connecticut please hold"]={{path="chatsounds/autoadd/matrix_xp/customer support this is richard jones from connecticut please hold.ogg",length=3.4352154195011337},}
L["cypher i need to learn kung fu now"]={{path="chatsounds/autoadd/matrix_xp/cypher i need to learn kung fu now.ogg",length=2.3928344671201813},}
L["error report"]={{path="chatsounds/autoadd/matrix_xp/error report.ogg",length=1.1310204081632653},}
L["freeze"]={{path="chatsounds/autoadd/matrix_xp/freeze.ogg",length=1.2702721088435374},}
L["go on without me"]={{path="chatsounds/autoadd/matrix_xp/go on without me.ogg",length=1.3589115646258503},}
...
L["looks like you try to free humanity want some help"]={{path="chatsounds/autoadd/matrix_xp/looks like you try to free humanity want some help.ogg",length=2.899251700680272},}
L["machines run the matrix on windows xp"]={{path="chatsounds/autoadd/matrix_xp/machines run the matrix on windows xp.ogg",length=2.0868707482993196},}
L["mr anderson mr anderson mr anderson aargh"]={{path="chatsounds/autoadd/matrix_xp/mr anderson mr anderson mr anderson aargh.ogg",length=3.6335600907029479},}
L["neo its cypher"]={{path="chatsounds/autoadd/matrix_xp/neo its cypher.ogg",length=0.89045351473922907},}
