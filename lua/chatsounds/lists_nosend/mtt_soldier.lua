...
L["then he used his fight money to buy two of every animal on earth"]={{path="chatsounds/autoadd/mtt_soldier/then he used his fight money to buy two of every animal on earth.ogg",length=4.1388208616780044}}
L["two of every animal on earth"]={{path="chatsounds/autoadd/mtt_soldier/two of every animal on earth.ogg",length=1.8331519274376418}}
L["unless its a farm"]={{path="chatsounds/autoadd/mtt_soldier/unless its a farm.ogg",length=1.4760997732426304}}
L["zoo"]={{path="chatsounds/autoadd/mtt_soldier/zoo.ogg",length=0.42882086167800454}}
c.EndList()