...
L["aahh"]={{path="chatsounds/autoadd/hl2_edits/aahh.ogg",length=5.853}}
L["butt"]={{path="chatsounds/autoadd/hl2_edits/butt.ogg",length=0.434}}
L["crowbar"]={{path="chatsounds/autoadd/hl2_edits/crowbar.ogg",length=1.252}}
L["doctor breerb"]={{path="chatsounds/autoadd/hl2_edits/doctor breerb.ogg",length=1.149}}
L["dr breerb"]={{path="chatsounds/autoadd/hl2_edits/dr breerb.ogg",length=1.149}}
L["eeeuuuggghhh"]={{path="chatsounds/autoadd/hl2_edits/eeeuuuggghhh.ogg",length=6.120}}
L["freeerf"]={{path="chatsounds/autoadd/hl2_edits/freeerf.ogg",length=1.107}}
