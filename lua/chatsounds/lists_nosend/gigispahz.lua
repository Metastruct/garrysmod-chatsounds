...
L["team rocket blasting off again"]={{path="chatsounds/autoadd/gigispahz/team rocket blasting off again.ogg",length=3.1349206349206349}}
L["the royal three beans salad"]={{path="chatsounds/autoadd/gigispahz/the royal three beans salad.ogg",length=2.6488888888888891}}
L["wat"]={{path="chatsounds/autoadd/gigispahz/wat.ogg",length=0.42643990929705217}}
L["youve come to mah court because youve been accused of stealing"]={{path="chatsounds/autoadd/gigispahz/youve come to mah court because youve been accused of stealing.ogg",length=4.0544444444444441}}
c.EndList()